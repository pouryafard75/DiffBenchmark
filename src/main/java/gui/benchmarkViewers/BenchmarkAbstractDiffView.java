package gui.benchmarkViewers;

import com.github.gumtreediff.actions.Diff;
import org.rendersnake.Renderable;

/* Created by pourya on 2024-06-03*/
public abstract class BenchmarkAbstractDiffView implements Renderable {
    ...
    public BenchmarkAbstractDiffView(String toolName, String srcFileName, String dstFileName, Diff diff, int id, int numOfDiffs, String routePath, boolean isMovedDiff) {
