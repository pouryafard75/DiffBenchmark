...
public abstract class BenchmarkAbstractMenuBar implements Renderable {
...
//        if (rem == 0) return txt;
    ...
    public BenchmarkAbstractMenuBar(String toolName, String routePath, int id, int numOfDiffs, boolean isMovedDiff) {
