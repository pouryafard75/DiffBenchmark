...
import benchmark.oracle.generators.tools.models.ASTDiffProvider;
import benchmark.oracle.generators.tools.models.ASTDiffProviderFactory;
import benchmark.oracle.generators.tools.runners.*;
import benchmark.oracle.generators.tools.runners.converter.PerfectDiff;
import benchmark.oracle.generators.tools.runners.gt.hacks.interfile.StagedTreeMatchingGumTreeASTDiffProvider;
import benchmark.oracle.generators.tools.runners.gt.hacks.labels.MergedLabelsGumTreeASTDiff;
import benchmark.oracle.generators.tools.runners.gt.hacks.labels.MergedTypesGumTreeASTDiff;
import benchmark.oracle.generators.tools.runners.shaded.IJM;
import benchmark.oracle.generators.tools.runners.shaded.MTDiff;
import benchmark.oracle.generators.tools.runners.gt.GreedyGumTreeASTDiffProvider;
import benchmark.oracle.generators.tools.runners.gt.SimpleGumTreeASTDiffProvider;
import benchmark.oracle.generators.tools.runners.gt.hacks.interfile.EfficientProjectGumTreeASTDiffProvider;
import benchmark.oracle.generators.tools.runners.gt.hacks.interfile.SingleVirtualNodeGumTreeASTDiffProvider;
import benchmark.oracle.generators.tools.runners.gt.hacks.multimapping.CopyPaste;
import benchmark.oracle.generators.tools.runners.trivial.TrivialDiff;
import benchmark.oracle.generators.tools.runners.converter.RM2;
import benchmark.oracle.generators.tools.runners.shaded.GT2;
