package gui.benchmarkViewers.vanilla;
...
import gui.webdiff.viewers.vanilla.VanillaDiffHtmlBuilder;
...
public class BenchmarkVanillaView extends BenchmarkAbstractDiffView implements Renderable {
    private final VanillaDiffHtmlBuilder rawHtmlDiff;
    private final boolean dump;

    public BenchmarkVanillaView(String toolName, String srcFileName, String dstFileName, Diff diff, int id, int numOfDiffs, String routePath, boolean isMovedDiff, String srcFileContent, String dstFileContent, boolean dump) throws IOException {
